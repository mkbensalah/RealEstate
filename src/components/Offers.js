                                                ...
                                                <div className="btn-group bootstrap-select">
                                                    ...
                                                    <div className="dropdown-menu open">
                                                        <ul className="dropdown-menu inner" role="menu">
                                                            <li data-original-index="0"><a tabindex="0" href="index.html" data-tokens="null"><span className="text">Default Order</span><span className="glyphicon glyphicon-ok check-mark"></span></a></li>
                                                            <li data-original-index="1"><a tabindex="0" href="index.html" data-tokens="null"><span className="text">Price (Low to High)</span><span className="glyphicon glyphicon-ok check-mark"></span></a></li>
                                                            <li data-original-index="2"><a tabindex="0" href="index.html" data-tokens="null"><span className="text">Price (High to Low)</span><span className="glyphicon glyphicon-ok check-mark"></span></a></li>
                                                            <li data-original-index="3"><a tabindex="0" href="index.html" data-tokens="null"><span className="text">Featured First</span><span className="glyphicon glyphicon-ok check-mark"></span></a></li>
                                                            <li data-original-index="4"><a tabindex="0" href="index.html" data-tokens="null"><span className="text">Date Old to New</span><span className="glyphicon glyphicon-ok check-mark"></span></a></li>
                                                            <li data-original-index="5" className="selected"><a tabindex="0" href="index.html" data-tokens="null"><span className="text">Date New to Old</span><span className="glyphicon glyphicon-ok check-mark"></span></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div className="col-lg-8 col-md-8 col-sm-12 col-xs-12 list-grid-area container-contentbar">
                                ...
                                <div className="pagination-main ">
                                    <ul className="pagination">
                                        <li className="disabled"><a aria-label="Previous" href="in.html" ><span ><i href="in.html" className="fa fa-angle-left"></i></span></a></li>
                                        <li className="active"><a data-houzepagi="1" href="in.html">1 <span className="sr-only"></span></a></li>
                                        <li><a data-houzepagi="2" href="in.html">2</a></li>
                                        <li><a data-houzepagi="3" href="in.html">3</a></li>
                                        <li><a data-houzepagi="2" rel="Next" href="in.html"><span ><i className="fa fa-angle-right"></i></span></a></li>
                                        <li><a data-houzepagi="6" rel="Last" href="in.html"><span><i className="fa fa-angle-double-right"></i></span></a></li>
                                    </ul>
                                </div>
                            </div>
